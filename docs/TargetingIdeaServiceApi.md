# yahoo_ads_search.TargetingIdeaServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**targeting_idea_service_get_post**](TargetingIdeaServiceApi.md#targeting_idea_service_get_post) | **POST** /TargetingIdeaService/get |


# **targeting_idea_service_get_post**
> TargetingIdeaServiceGetResponse targeting_idea_service_get_post(targeting_idea_service_selector=targeting_idea_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.TargetingIdeaServiceApi(api_client)
    targeting_idea_service_selector = yahoo_ads_search.TargetingIdeaServiceSelector() # TargetingIdeaServiceSelector |  (optional)

    try:
        api_response = api_instance.targeting_idea_service_get_post(targeting_idea_service_selector=targeting_idea_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TargetingIdeaServiceApi->targeting_idea_service_get_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **targeting_idea_service_selector** | [**TargetingIdeaServiceSelector**](TargetingIdeaServiceSelector.md)|  | [optional]

### Return type

[**TargetingIdeaServiceGetResponse**](TargetingIdeaServiceGetResponse.md)
