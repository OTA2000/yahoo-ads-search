# yahoo_ads_search.FeedServiceApi
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.FeedServiceApi(api_client)
    feed_service_operation = yahoo_ads_search.FeedServiceOperation() # FeedServiceOperation |  (optional)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.FeedServiceApi(api_client)
    feed_service_selector = yahoo_ads_search.FeedServiceSelector() # FeedServiceSelector |  (optional)
