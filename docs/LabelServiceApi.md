# yahoo_ads_search.LabelServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**label_service_add_post**](LabelServiceApi.md#label_service_add_post) | **POST** /LabelService/add |
[**label_service_get_post**](LabelServiceApi.md#label_service_get_post) | **POST** /LabelService/get |
[**label_service_remove_post**](LabelServiceApi.md#label_service_remove_post) | **POST** /LabelService/remove |
[**label_service_set_post**](LabelServiceApi.md#label_service_set_post) | **POST** /LabelService/set |


# **label_service_add_post**
> LabelServiceMutateResponse label_service_add_post(label_service_operation=label_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.LabelServiceApi(api_client)
    label_service_operation = yahoo_ads_search.LabelServiceOperation() # LabelServiceOperation |  (optional)

    try:
        api_response = api_instance.label_service_add_post(label_service_operation=label_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling LabelServiceApi->label_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **label_service_operation** | [**LabelServiceOperation**](LabelServiceOperation.md)|  | [optional]

### Return type

[**LabelServiceMutateResponse**](LabelServiceMutateResponse.md)
...
> LabelServiceGetResponse label_service_get_post(label_service_selector=label_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.LabelServiceApi(api_client)
    label_service_selector = yahoo_ads_search.LabelServiceSelector() # LabelServiceSelector |  (optional)

    try:
        api_response = api_instance.label_service_get_post(label_service_selector=label_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling LabelServiceApi->label_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **label_service_selector** | [**LabelServiceSelector**](LabelServiceSelector.md)|  | [optional]

### Return type

[**LabelServiceGetResponse**](LabelServiceGetResponse.md)
...
> LabelServiceMutateResponse label_service_remove_post(label_service_operation=label_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.label_service_remove_post(label_service_operation=label_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling LabelServiceApi->label_service_remove_post: %s\n" % e)
```
...
> LabelServiceMutateResponse label_service_set_post(label_service_operation=label_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.label_service_set_post(label_service_operation=label_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling LabelServiceApi->label_service_set_post: %s\n" % e)
```
