# yahoo_ads_search.CampaignRetargetingListServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**campaign_retargeting_list_service_add_post**](CampaignRetargetingListServiceApi.md#campaign_retargeting_list_service_add_post) | **POST** /CampaignRetargetingListService/add |
[**campaign_retargeting_list_service_get_post**](CampaignRetargetingListServiceApi.md#campaign_retargeting_list_service_get_post) | **POST** /CampaignRetargetingListService/get |
[**campaign_retargeting_list_service_remove_post**](CampaignRetargetingListServiceApi.md#campaign_retargeting_list_service_remove_post) | **POST** /CampaignRetargetingListService/remove |
[**campaign_retargeting_list_service_set_post**](CampaignRetargetingListServiceApi.md#campaign_retargeting_list_service_set_post) | **POST** /CampaignRetargetingListService/set |


# **campaign_retargeting_list_service_add_post**
> CampaignRetargetingListServiceMutateResponse campaign_retargeting_list_service_add_post(campaign_retargeting_list_service_operation=campaign_retargeting_list_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.CampaignRetargetingListServiceApi(api_client)
    campaign_retargeting_list_service_operation = yahoo_ads_search.CampaignRetargetingListServiceOperation() # CampaignRetargetingListServiceOperation |  (optional)

    try:
        api_response = api_instance.campaign_retargeting_list_service_add_post(campaign_retargeting_list_service_operation=campaign_retargeting_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignRetargetingListServiceApi->campaign_retargeting_list_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **campaign_retargeting_list_service_operation** | [**CampaignRetargetingListServiceOperation**](CampaignRetargetingListServiceOperation.md)|  | [optional]

### Return type

[**CampaignRetargetingListServiceMutateResponse**](CampaignRetargetingListServiceMutateResponse.md)
...
# **campaign_retargeting_list_service_get_post**
> CampaignRetargetingListServiceGetResponse campaign_retargeting_list_service_get_post(campaign_retargeting_list_service_selector=campaign_retargeting_list_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.CampaignRetargetingListServiceApi(api_client)
    campaign_retargeting_list_service_selector = yahoo_ads_search.CampaignRetargetingListServiceSelector() # CampaignRetargetingListServiceSelector |  (optional)

    try:
        api_response = api_instance.campaign_retargeting_list_service_get_post(campaign_retargeting_list_service_selector=campaign_retargeting_list_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignRetargetingListServiceApi->campaign_retargeting_list_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **campaign_retargeting_list_service_selector** | [**CampaignRetargetingListServiceSelector**](CampaignRetargetingListServiceSelector.md)|  | [optional]

### Return type

[**CampaignRetargetingListServiceGetResponse**](CampaignRetargetingListServiceGetResponse.md)
...
# **campaign_retargeting_list_service_remove_post**
> CampaignRetargetingListServiceMutateResponse campaign_retargeting_list_service_remove_post(campaign_retargeting_list_service_operation=campaign_retargeting_list_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.campaign_retargeting_list_service_remove_post(campaign_retargeting_list_service_operation=campaign_retargeting_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignRetargetingListServiceApi->campaign_retargeting_list_service_remove_post: %s\n" % e)
```
...
# **campaign_retargeting_list_service_set_post**
> CampaignRetargetingListServiceMutateResponse campaign_retargeting_list_service_set_post(campaign_retargeting_list_service_operation=campaign_retargeting_list_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.campaign_retargeting_list_service_set_post(campaign_retargeting_list_service_operation=campaign_retargeting_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignRetargetingListServiceApi->campaign_retargeting_list_service_set_post: %s\n" % e)
```
