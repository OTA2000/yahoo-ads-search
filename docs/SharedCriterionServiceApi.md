# yahoo_ads_search.SharedCriterionServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**shared_criterion_service_add_post**](SharedCriterionServiceApi.md#shared_criterion_service_add_post) | **POST** /SharedCriterionService/add |
[**shared_criterion_service_get_post**](SharedCriterionServiceApi.md#shared_criterion_service_get_post) | **POST** /SharedCriterionService/get |
[**shared_criterion_service_remove_post**](SharedCriterionServiceApi.md#shared_criterion_service_remove_post) | **POST** /SharedCriterionService/remove |


# **shared_criterion_service_add_post**
> SharedCriterionServiceMutateResponse shared_criterion_service_add_post(shared_criterion_service_operation=shared_criterion_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.SharedCriterionServiceApi(api_client)
    shared_criterion_service_operation = yahoo_ads_search.SharedCriterionServiceOperation() # SharedCriterionServiceOperation |  (optional)

    try:
        api_response = api_instance.shared_criterion_service_add_post(shared_criterion_service_operation=shared_criterion_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling SharedCriterionServiceApi->shared_criterion_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **shared_criterion_service_operation** | [**SharedCriterionServiceOperation**](SharedCriterionServiceOperation.md)|  | [optional]

### Return type

[**SharedCriterionServiceMutateResponse**](SharedCriterionServiceMutateResponse.md)
...
> SharedCriterionServiceGetResponse shared_criterion_service_get_post(shared_criterion_service_selector=shared_criterion_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.SharedCriterionServiceApi(api_client)
    shared_criterion_service_selector = yahoo_ads_search.SharedCriterionServiceSelector() # SharedCriterionServiceSelector |  (optional)

    try:
        api_response = api_instance.shared_criterion_service_get_post(shared_criterion_service_selector=shared_criterion_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling SharedCriterionServiceApi->shared_criterion_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **shared_criterion_service_selector** | [**SharedCriterionServiceSelector**](SharedCriterionServiceSelector.md)|  | [optional]

### Return type

[**SharedCriterionServiceGetResponse**](SharedCriterionServiceGetResponse.md)
...
> SharedCriterionServiceMutateResponse shared_criterion_service_remove_post(shared_criterion_service_operation=shared_criterion_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.shared_criterion_service_remove_post(shared_criterion_service_operation=shared_criterion_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling SharedCriterionServiceApi->shared_criterion_service_remove_post: %s\n" % e)
```
