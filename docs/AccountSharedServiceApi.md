# yahoo_ads_search.AccountSharedServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**account_shared_service_add_post**](AccountSharedServiceApi.md#account_shared_service_add_post) | **POST** /AccountSharedService/add |
[**account_shared_service_get_post**](AccountSharedServiceApi.md#account_shared_service_get_post) | **POST** /AccountSharedService/get |
[**account_shared_service_remove_post**](AccountSharedServiceApi.md#account_shared_service_remove_post) | **POST** /AccountSharedService/remove |
[**account_shared_service_set_post**](AccountSharedServiceApi.md#account_shared_service_set_post) | **POST** /AccountSharedService/set |


# **account_shared_service_add_post**
> AccountSharedServiceMutateResponse account_shared_service_add_post(account_shared_service_operation=account_shared_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.AccountSharedServiceApi(api_client)
    account_shared_service_operation = yahoo_ads_search.AccountSharedServiceOperation() # AccountSharedServiceOperation |  (optional)

    try:
        api_response = api_instance.account_shared_service_add_post(account_shared_service_operation=account_shared_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AccountSharedServiceApi->account_shared_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **account_shared_service_operation** | [**AccountSharedServiceOperation**](AccountSharedServiceOperation.md)|  | [optional]

### Return type

[**AccountSharedServiceMutateResponse**](AccountSharedServiceMutateResponse.md)
...
> AccountSharedServiceGetResponse account_shared_service_get_post(account_shared_service_selector=account_shared_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.AccountSharedServiceApi(api_client)
    account_shared_service_selector = yahoo_ads_search.AccountSharedServiceSelector() # AccountSharedServiceSelector |  (optional)

    try:
        api_response = api_instance.account_shared_service_get_post(account_shared_service_selector=account_shared_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AccountSharedServiceApi->account_shared_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **account_shared_service_selector** | [**AccountSharedServiceSelector**](AccountSharedServiceSelector.md)|  | [optional]

### Return type

[**AccountSharedServiceGetResponse**](AccountSharedServiceGetResponse.md)
...
> AccountSharedServiceMutateResponse account_shared_service_remove_post(account_shared_service_operation=account_shared_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.account_shared_service_remove_post(account_shared_service_operation=account_shared_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AccountSharedServiceApi->account_shared_service_remove_post: %s\n" % e)
```
...
> AccountSharedServiceMutateResponse account_shared_service_set_post(account_shared_service_operation=account_shared_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.account_shared_service_set_post(account_shared_service_operation=account_shared_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AccountSharedServiceApi->account_shared_service_set_post: %s\n" % e)
```
