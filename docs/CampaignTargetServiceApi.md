# yahoo_ads_search.CampaignTargetServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**campaign_target_service_add_post**](CampaignTargetServiceApi.md#campaign_target_service_add_post) | **POST** /CampaignTargetService/add |
[**campaign_target_service_get_post**](CampaignTargetServiceApi.md#campaign_target_service_get_post) | **POST** /CampaignTargetService/get |
[**campaign_target_service_remove_post**](CampaignTargetServiceApi.md#campaign_target_service_remove_post) | **POST** /CampaignTargetService/remove |
[**campaign_target_service_set_post**](CampaignTargetServiceApi.md#campaign_target_service_set_post) | **POST** /CampaignTargetService/set |


# **campaign_target_service_add_post**
> CampaignTargetServiceMutateResponse campaign_target_service_add_post(campaign_target_service_operation=campaign_target_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.CampaignTargetServiceApi(api_client)
    campaign_target_service_operation = yahoo_ads_search.CampaignTargetServiceOperation() # CampaignTargetServiceOperation |  (optional)

    try:
        api_response = api_instance.campaign_target_service_add_post(campaign_target_service_operation=campaign_target_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignTargetServiceApi->campaign_target_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **campaign_target_service_operation** | [**CampaignTargetServiceOperation**](CampaignTargetServiceOperation.md)|  | [optional]

### Return type

[**CampaignTargetServiceMutateResponse**](CampaignTargetServiceMutateResponse.md)
...
> CampaignTargetServiceGetResponse campaign_target_service_get_post(campaign_target_service_selector=campaign_target_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.CampaignTargetServiceApi(api_client)
    campaign_target_service_selector = yahoo_ads_search.CampaignTargetServiceSelector() # CampaignTargetServiceSelector |  (optional)

    try:
        api_response = api_instance.campaign_target_service_get_post(campaign_target_service_selector=campaign_target_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignTargetServiceApi->campaign_target_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **campaign_target_service_selector** | [**CampaignTargetServiceSelector**](CampaignTargetServiceSelector.md)|  | [optional]

### Return type

[**CampaignTargetServiceGetResponse**](CampaignTargetServiceGetResponse.md)
...
> CampaignTargetServiceMutateResponse campaign_target_service_remove_post(campaign_target_service_operation=campaign_target_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.campaign_target_service_remove_post(campaign_target_service_operation=campaign_target_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignTargetServiceApi->campaign_target_service_remove_post: %s\n" % e)
```
...
> CampaignTargetServiceMutateResponse campaign_target_service_set_post(campaign_target_service_operation=campaign_target_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.campaign_target_service_set_post(campaign_target_service_operation=campaign_target_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignTargetServiceApi->campaign_target_service_set_post: %s\n" % e)
```
