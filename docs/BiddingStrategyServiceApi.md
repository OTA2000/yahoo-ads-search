# yahoo_ads_search.BiddingStrategyServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**bidding_strategy_service_add_post**](BiddingStrategyServiceApi.md#bidding_strategy_service_add_post) | **POST** /BiddingStrategyService/add |
[**bidding_strategy_service_get_post**](BiddingStrategyServiceApi.md#bidding_strategy_service_get_post) | **POST** /BiddingStrategyService/get |
[**bidding_strategy_service_remove_post**](BiddingStrategyServiceApi.md#bidding_strategy_service_remove_post) | **POST** /BiddingStrategyService/remove |
[**bidding_strategy_service_set_post**](BiddingStrategyServiceApi.md#bidding_strategy_service_set_post) | **POST** /BiddingStrategyService/set |


# **bidding_strategy_service_add_post**
> BiddingStrategyServiceMutateResponse bidding_strategy_service_add_post(bidding_strategy_service_operation=bidding_strategy_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.BiddingStrategyServiceApi(api_client)
    bidding_strategy_service_operation = yahoo_ads_search.BiddingStrategyServiceOperation() # BiddingStrategyServiceOperation |  (optional)

    try:
        api_response = api_instance.bidding_strategy_service_add_post(bidding_strategy_service_operation=bidding_strategy_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling BiddingStrategyServiceApi->bidding_strategy_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **bidding_strategy_service_operation** | [**BiddingStrategyServiceOperation**](BiddingStrategyServiceOperation.md)|  | [optional]

### Return type

[**BiddingStrategyServiceMutateResponse**](BiddingStrategyServiceMutateResponse.md)
...
> BiddingStrategyServiceGetResponse bidding_strategy_service_get_post(bidding_strategy_service_selector=bidding_strategy_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.BiddingStrategyServiceApi(api_client)
    bidding_strategy_service_selector = yahoo_ads_search.BiddingStrategyServiceSelector() # BiddingStrategyServiceSelector |  (optional)

    try:
        api_response = api_instance.bidding_strategy_service_get_post(bidding_strategy_service_selector=bidding_strategy_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling BiddingStrategyServiceApi->bidding_strategy_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bidding_strategy_service_selector** | [**BiddingStrategyServiceSelector**](BiddingStrategyServiceSelector.md)|  | [optional]

### Return type

[**BiddingStrategyServiceGetResponse**](BiddingStrategyServiceGetResponse.md)
...
> BiddingStrategyServiceMutateResponse bidding_strategy_service_remove_post(bidding_strategy_service_operation=bidding_strategy_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.bidding_strategy_service_remove_post(bidding_strategy_service_operation=bidding_strategy_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling BiddingStrategyServiceApi->bidding_strategy_service_remove_post: %s\n" % e)
```
...
> BiddingStrategyServiceMutateResponse bidding_strategy_service_set_post(bidding_strategy_service_operation=bidding_strategy_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.bidding_strategy_service_set_post(bidding_strategy_service_operation=bidding_strategy_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling BiddingStrategyServiceApi->bidding_strategy_service_set_post: %s\n" % e)
```
