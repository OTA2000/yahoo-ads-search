# yahoo_ads_search.AccountServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**account_service_get_post**](AccountServiceApi.md#account_service_get_post) | **POST** /AccountService/get |
[**account_service_set_post**](AccountServiceApi.md#account_service_set_post) | **POST** /AccountService/set |


# **account_service_get_post**
> AccountServiceGetResponse account_service_get_post(account_service_selector=account_service_selector)
...
------------- | ------------- | ------------- | -------------
 **account_service_selector** | [**AccountServiceSelector**](AccountServiceSelector.md)|  | [optional]

### Return type

[**AccountServiceGetResponse**](AccountServiceGetResponse.md)
...
> AccountServiceMutateResponse account_service_set_post(account_service_operation=account_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.AccountServiceApi(api_client)
    account_service_operation = yahoo_ads_search.AccountServiceOperation() # AccountServiceOperation |  (optional)

    try:
        api_response = api_instance.account_service_set_post(account_service_operation=account_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AccountServiceApi->account_service_set_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **account_service_operation** | [**AccountServiceOperation**](AccountServiceOperation.md)|  | [optional]

### Return type

[**AccountServiceMutateResponse**](AccountServiceMutateResponse.md)
