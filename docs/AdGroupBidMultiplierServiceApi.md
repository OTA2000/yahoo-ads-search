# yahoo_ads_search.AdGroupBidMultiplierServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**ad_group_bid_multiplier_service_get_post**](AdGroupBidMultiplierServiceApi.md#ad_group_bid_multiplier_service_get_post) | **POST** /AdGroupBidMultiplierService/get |
[**ad_group_bid_multiplier_service_remove_post**](AdGroupBidMultiplierServiceApi.md#ad_group_bid_multiplier_service_remove_post) | **POST** /AdGroupBidMultiplierService/remove |
[**ad_group_bid_multiplier_service_set_post**](AdGroupBidMultiplierServiceApi.md#ad_group_bid_multiplier_service_set_post) | **POST** /AdGroupBidMultiplierService/set |


# **ad_group_bid_multiplier_service_get_post**
> AdGroupBidMultiplierServiceGetResponse ad_group_bid_multiplier_service_get_post(ad_group_bid_multiplier_service_selector=ad_group_bid_multiplier_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.AdGroupBidMultiplierServiceApi(api_client)
    ad_group_bid_multiplier_service_selector = yahoo_ads_search.AdGroupBidMultiplierServiceSelector() # AdGroupBidMultiplierServiceSelector |  (optional)

    try:
        api_response = api_instance.ad_group_bid_multiplier_service_get_post(ad_group_bid_multiplier_service_selector=ad_group_bid_multiplier_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AdGroupBidMultiplierServiceApi->ad_group_bid_multiplier_service_get_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **ad_group_bid_multiplier_service_selector** | [**AdGroupBidMultiplierServiceSelector**](AdGroupBidMultiplierServiceSelector.md)|  | [optional]

### Return type

[**AdGroupBidMultiplierServiceGetResponse**](AdGroupBidMultiplierServiceGetResponse.md)
...
> AdGroupBidMultiplierServiceMutateResponse ad_group_bid_multiplier_service_remove_post(ad_group_bid_multiplier_service_operation=ad_group_bid_multiplier_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.AdGroupBidMultiplierServiceApi(api_client)
    ad_group_bid_multiplier_service_operation = yahoo_ads_search.AdGroupBidMultiplierServiceOperation() # AdGroupBidMultiplierServiceOperation |  (optional)

    try:
        api_response = api_instance.ad_group_bid_multiplier_service_remove_post(ad_group_bid_multiplier_service_operation=ad_group_bid_multiplier_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AdGroupBidMultiplierServiceApi->ad_group_bid_multiplier_service_remove_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ad_group_bid_multiplier_service_operation** | [**AdGroupBidMultiplierServiceOperation**](AdGroupBidMultiplierServiceOperation.md)|  | [optional]

### Return type

[**AdGroupBidMultiplierServiceMutateResponse**](AdGroupBidMultiplierServiceMutateResponse.md)
...
> AdGroupBidMultiplierServiceMutateResponse ad_group_bid_multiplier_service_set_post(ad_group_bid_multiplier_service_operation=ad_group_bid_multiplier_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.ad_group_bid_multiplier_service_set_post(ad_group_bid_multiplier_service_operation=ad_group_bid_multiplier_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AdGroupBidMultiplierServiceApi->ad_group_bid_multiplier_service_set_post: %s\n" % e)
```
