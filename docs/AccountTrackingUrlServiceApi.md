# yahoo_ads_search.AccountTrackingUrlServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**account_tracking_url_service_get_post**](AccountTrackingUrlServiceApi.md#account_tracking_url_service_get_post) | **POST** /AccountTrackingUrlService/get |
[**account_tracking_url_service_set_post**](AccountTrackingUrlServiceApi.md#account_tracking_url_service_set_post) | **POST** /AccountTrackingUrlService/set |


# **account_tracking_url_service_get_post**
> AccountTrackingUrlServiceGetResponse account_tracking_url_service_get_post(account_tracking_url_service_selector=account_tracking_url_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.AccountTrackingUrlServiceApi(api_client)
    account_tracking_url_service_selector = yahoo_ads_search.AccountTrackingUrlServiceSelector() # AccountTrackingUrlServiceSelector |  (optional)

    try:
        api_response = api_instance.account_tracking_url_service_get_post(account_tracking_url_service_selector=account_tracking_url_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AccountTrackingUrlServiceApi->account_tracking_url_service_get_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **account_tracking_url_service_selector** | [**AccountTrackingUrlServiceSelector**](AccountTrackingUrlServiceSelector.md)|  | [optional]

### Return type

[**AccountTrackingUrlServiceGetResponse**](AccountTrackingUrlServiceGetResponse.md)
...
> AccountTrackingUrlServiceMutateResponse account_tracking_url_service_set_post(account_tracking_url_service_operation=account_tracking_url_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.AccountTrackingUrlServiceApi(api_client)
    account_tracking_url_service_operation = yahoo_ads_search.AccountTrackingUrlServiceOperation() # AccountTrackingUrlServiceOperation |  (optional)

    try:
        api_response = api_instance.account_tracking_url_service_set_post(account_tracking_url_service_operation=account_tracking_url_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AccountTrackingUrlServiceApi->account_tracking_url_service_set_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **account_tracking_url_service_operation** | [**AccountTrackingUrlServiceOperation**](AccountTrackingUrlServiceOperation.md)|  | [optional]

### Return type

[**AccountTrackingUrlServiceMutateResponse**](AccountTrackingUrlServiceMutateResponse.md)
