# yahoo_ads_search.CampaignLabelServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**campaign_label_service_add_post**](CampaignLabelServiceApi.md#campaign_label_service_add_post) | **POST** /CampaignLabelService/add |
[**campaign_label_service_remove_post**](CampaignLabelServiceApi.md#campaign_label_service_remove_post) | **POST** /CampaignLabelService/remove |


# **campaign_label_service_add_post**
> CampaignLabelServiceMutateResponse campaign_label_service_add_post(campaign_label_service_operation=campaign_label_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.CampaignLabelServiceApi(api_client)
    campaign_label_service_operation = yahoo_ads_search.CampaignLabelServiceOperation() # CampaignLabelServiceOperation |  (optional)

    try:
        api_response = api_instance.campaign_label_service_add_post(campaign_label_service_operation=campaign_label_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignLabelServiceApi->campaign_label_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **campaign_label_service_operation** | [**CampaignLabelServiceOperation**](CampaignLabelServiceOperation.md)|  | [optional]

### Return type

[**CampaignLabelServiceMutateResponse**](CampaignLabelServiceMutateResponse.md)
...
> CampaignLabelServiceMutateResponse campaign_label_service_remove_post(campaign_label_service_operation=campaign_label_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.campaign_label_service_remove_post(campaign_label_service_operation=campaign_label_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignLabelServiceApi->campaign_label_service_remove_post: %s\n" % e)
```
