# yahoo_ads_search.CampaignExportServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**campaign_export_service_add_job_post**](CampaignExportServiceApi.md#campaign_export_service_add_job_post) | **POST** /CampaignExportService/addJob |
[**campaign_export_service_download_post**](CampaignExportServiceApi.md#campaign_export_service_download_post) | **POST** /CampaignExportService/download |
[**campaign_export_service_get_export_fields_get**](CampaignExportServiceApi.md#campaign_export_service_get_export_fields_get) | **GET** /CampaignExportService/getExportFields |
[**campaign_export_service_get_post**](CampaignExportServiceApi.md#campaign_export_service_get_post) | **POST** /CampaignExportService/get |


# **campaign_export_service_add_job_post**
> CampaignExportServiceAddJobResponse campaign_export_service_add_job_post(campaign_export_service_job_operation=campaign_export_service_job_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.CampaignExportServiceApi(api_client)
    campaign_export_service_job_operation = yahoo_ads_search.CampaignExportServiceJobOperation() # CampaignExportServiceJobOperation |  (optional)

    try:
        api_response = api_instance.campaign_export_service_add_job_post(campaign_export_service_job_operation=campaign_export_service_job_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignExportServiceApi->campaign_export_service_add_job_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **campaign_export_service_job_operation** | [**CampaignExportServiceJobOperation**](CampaignExportServiceJobOperation.md)|  | [optional]

### Return type

[**CampaignExportServiceAddJobResponse**](CampaignExportServiceAddJobResponse.md)
...
> file campaign_export_service_download_post(campaign_export_service_download_selector=campaign_export_service_download_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.CampaignExportServiceApi(api_client)
    campaign_export_service_download_selector = yahoo_ads_search.CampaignExportServiceDownloadSelector() # CampaignExportServiceDownloadSelector |  (optional)

    try:
        api_response = api_instance.campaign_export_service_download_post(campaign_export_service_download_selector=campaign_export_service_download_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignExportServiceApi->campaign_export_service_download_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **campaign_export_service_download_selector** | [**CampaignExportServiceDownloadSelector**](CampaignExportServiceDownloadSelector.md)|  | [optional]
...
# **campaign_export_service_get_export_fields_get**
> CampaignExportServiceGetExportFieldsResponse campaign_export_service_get_export_fields_get()
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.campaign_export_service_get_export_fields_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignExportServiceApi->campaign_export_service_get_export_fields_get: %s\n" % e)
```
...
[**CampaignExportServiceGetExportFieldsResponse**](CampaignExportServiceGetExportFieldsResponse.md)
...
> CampaignExportServiceGetResponse campaign_export_service_get_post(campaign_export_service_selector=campaign_export_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.CampaignExportServiceApi(api_client)
    campaign_export_service_selector = yahoo_ads_search.CampaignExportServiceSelector() # CampaignExportServiceSelector |  (optional)

    try:
        api_response = api_instance.campaign_export_service_get_post(campaign_export_service_selector=campaign_export_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignExportServiceApi->campaign_export_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **campaign_export_service_selector** | [**CampaignExportServiceSelector**](CampaignExportServiceSelector.md)|  | [optional]

### Return type

[**CampaignExportServiceGetResponse**](CampaignExportServiceGetResponse.md)
