# yahoo_ads_search.BalanceServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**balance_service_get_post**](BalanceServiceApi.md#balance_service_get_post) | **POST** /BalanceService/get |


# **balance_service_get_post**
> BalanceServiceGetResponse balance_service_get_post(balance_service_selector=balance_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.BalanceServiceApi(api_client)
    balance_service_selector = yahoo_ads_search.BalanceServiceSelector() # BalanceServiceSelector |  (optional)

    try:
        api_response = api_instance.balance_service_get_post(balance_service_selector=balance_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling BalanceServiceApi->balance_service_get_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **balance_service_selector** | [**BalanceServiceSelector**](BalanceServiceSelector.md)|  | [optional]

### Return type

[**BalanceServiceGetResponse**](BalanceServiceGetResponse.md)
