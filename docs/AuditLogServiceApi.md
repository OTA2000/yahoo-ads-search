# yahoo_ads_search.AuditLogServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**audit_log_service_add_job_post**](AuditLogServiceApi.md#audit_log_service_add_job_post) | **POST** /AuditLogService/addJob |
[**audit_log_service_download_post**](AuditLogServiceApi.md#audit_log_service_download_post) | **POST** /AuditLogService/download |
[**audit_log_service_get_post**](AuditLogServiceApi.md#audit_log_service_get_post) | **POST** /AuditLogService/get |


# **audit_log_service_add_job_post**
> AuditLogServiceAddJobResponse audit_log_service_add_job_post(audit_log_service_operation=audit_log_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.AuditLogServiceApi(api_client)
    audit_log_service_operation = yahoo_ads_search.AuditLogServiceOperation() # AuditLogServiceOperation |  (optional)

    try:
        api_response = api_instance.audit_log_service_add_job_post(audit_log_service_operation=audit_log_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AuditLogServiceApi->audit_log_service_add_job_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **audit_log_service_operation** | [**AuditLogServiceOperation**](AuditLogServiceOperation.md)|  | [optional]

### Return type

[**AuditLogServiceAddJobResponse**](AuditLogServiceAddJobResponse.md)
...
> file audit_log_service_download_post(audit_log_service_download_selector=audit_log_service_download_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.AuditLogServiceApi(api_client)
    audit_log_service_download_selector = yahoo_ads_search.AuditLogServiceDownloadSelector() # AuditLogServiceDownloadSelector |  (optional)

    try:
        api_response = api_instance.audit_log_service_download_post(audit_log_service_download_selector=audit_log_service_download_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AuditLogServiceApi->audit_log_service_download_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **audit_log_service_download_selector** | [**AuditLogServiceDownloadSelector**](AuditLogServiceDownloadSelector.md)|  | [optional]
...
> AuditLogServiceGetResponse audit_log_service_get_post(audit_log_service_selector=audit_log_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.AuditLogServiceApi(api_client)
    audit_log_service_selector = yahoo_ads_search.AuditLogServiceSelector() # AuditLogServiceSelector |  (optional)

    try:
        api_response = api_instance.audit_log_service_get_post(audit_log_service_selector=audit_log_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AuditLogServiceApi->audit_log_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **audit_log_service_selector** | [**AuditLogServiceSelector**](AuditLogServiceSelector.md)|  | [optional]

### Return type

[**AuditLogServiceGetResponse**](AuditLogServiceGetResponse.md)
