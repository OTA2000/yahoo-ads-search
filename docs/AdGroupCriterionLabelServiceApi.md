# yahoo_ads_search.AdGroupCriterionLabelServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**ad_group_criterion_label_service_add_post**](AdGroupCriterionLabelServiceApi.md#ad_group_criterion_label_service_add_post) | **POST** /AdGroupCriterionLabelService/add |
[**ad_group_criterion_label_service_remove_post**](AdGroupCriterionLabelServiceApi.md#ad_group_criterion_label_service_remove_post) | **POST** /AdGroupCriterionLabelService/remove |


# **ad_group_criterion_label_service_add_post**
> AdGroupCriterionLabelServiceMutateResponse ad_group_criterion_label_service_add_post(ad_group_criterion_label_service_operation=ad_group_criterion_label_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.AdGroupCriterionLabelServiceApi(api_client)
    ad_group_criterion_label_service_operation = yahoo_ads_search.AdGroupCriterionLabelServiceOperation() # AdGroupCriterionLabelServiceOperation |  (optional)

    try:
        api_response = api_instance.ad_group_criterion_label_service_add_post(ad_group_criterion_label_service_operation=ad_group_criterion_label_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AdGroupCriterionLabelServiceApi->ad_group_criterion_label_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **ad_group_criterion_label_service_operation** | [**AdGroupCriterionLabelServiceOperation**](AdGroupCriterionLabelServiceOperation.md)|  | [optional]

### Return type

[**AdGroupCriterionLabelServiceMutateResponse**](AdGroupCriterionLabelServiceMutateResponse.md)
...
> AdGroupCriterionLabelServiceMutateResponse ad_group_criterion_label_service_remove_post(ad_group_criterion_label_service_operation=ad_group_criterion_label_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.ad_group_criterion_label_service_remove_post(ad_group_criterion_label_service_operation=ad_group_criterion_label_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AdGroupCriterionLabelServiceApi->ad_group_criterion_label_service_remove_post: %s\n" % e)
```
