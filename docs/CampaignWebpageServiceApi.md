# yahoo_ads_search.CampaignWebpageServiceApi

All URIs are relative to *https://ads-search.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**campaign_webpage_service_add_post**](CampaignWebpageServiceApi.md#campaign_webpage_service_add_post) | **POST** /CampaignWebpageService/add |
[**campaign_webpage_service_get_post**](CampaignWebpageServiceApi.md#campaign_webpage_service_get_post) | **POST** /CampaignWebpageService/get |
[**campaign_webpage_service_remove_post**](CampaignWebpageServiceApi.md#campaign_webpage_service_remove_post) | **POST** /CampaignWebpageService/remove |


# **campaign_webpage_service_add_post**
> CampaignWebpageServiceMutateResponse campaign_webpage_service_add_post(campaign_webpage_service_operation=campaign_webpage_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_search.CampaignWebpageServiceApi(api_client)
    campaign_webpage_service_operation = yahoo_ads_search.CampaignWebpageServiceOperation() # CampaignWebpageServiceOperation |  (optional)

    try:
        api_response = api_instance.campaign_webpage_service_add_post(campaign_webpage_service_operation=campaign_webpage_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignWebpageServiceApi->campaign_webpage_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **campaign_webpage_service_operation** | [**CampaignWebpageServiceOperation**](CampaignWebpageServiceOperation.md)|  | [optional]

### Return type

[**CampaignWebpageServiceMutateResponse**](CampaignWebpageServiceMutateResponse.md)
...
> CampaignWebpageServiceGetResponse campaign_webpage_service_get_post(campaign_webpage_service_selector=campaign_webpage_service_selector)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_search.CampaignWebpageServiceApi(api_client)
    campaign_webpage_service_selector = yahoo_ads_search.CampaignWebpageServiceSelector() # CampaignWebpageServiceSelector |  (optional)

    try:
        api_response = api_instance.campaign_webpage_service_get_post(campaign_webpage_service_selector=campaign_webpage_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignWebpageServiceApi->campaign_webpage_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **campaign_webpage_service_selector** | [**CampaignWebpageServiceSelector**](CampaignWebpageServiceSelector.md)|  | [optional]

### Return type

[**CampaignWebpageServiceGetResponse**](CampaignWebpageServiceGetResponse.md)
...
> CampaignWebpageServiceMutateResponse campaign_webpage_service_remove_post(campaign_webpage_service_operation=campaign_webpage_service_operation)
...
with yahoo_ads_search.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.campaign_webpage_service_remove_post(campaign_webpage_service_operation=campaign_webpage_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling CampaignWebpageServiceApi->campaign_webpage_service_remove_post: %s\n" % e)
```
